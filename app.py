...
<a class="home-action-card" href="{nav_link('spec')}"><div class="action-icon">✓</div><div class="action-title">Spec Sample Order</div><div class="action-copy">Tell Nova what you need and build the verified PCNA order.</div></a>
<a class="home-action-card" href="{nav_link('virtual')}"><div class="action-icon">◇</div><div class="action-title">Virtual Designs</div><div class="action-copy">Ask Nova for product, kit or packaging virtuals and keep them in Projects.</div></a>
<a class="home-action-card" href="{nav_link('quote')}"><div class="action-icon">$</div><div class="action-title">Quote Request</div><div class="action-copy">Quote a verified PCNA product at the requested quantity.</div></a>
<a class="home-action-card" href="{projects_link()}"><div class="action-icon">▣</div><div class="action-title">Projects</div><div class="action-copy">Open your saved PCNA virtual and design projects.</div></a>
</div>
""",
        unsafe_allow_html=True,
    )
