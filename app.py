...
<div class="pcna-home">
  ...
  <div class="pcna-grid">
    <a class="pcna-card" href="?embed=true&page=spec" target="_self" onclick="event.preventDefault();window.location.assign(this.href);"><div class="pcna-card-icon">✓</div><div class="pcna-card-title">Spec Sample<br>Order</div><div class="pcna-card-sub">Tell Nova what you need and build the verified PCNA order.</div><div class="card-art backpack" aria-hidden="true"><div></div></div><div class="pcna-arrow">→</div></a>
    <a class="pcna-card" href="?embed=true&page=virtual" target="_self" onclick="event.preventDefault();window.location.assign(this.href);"><div class="pcna-card-icon">◇</div><div class="pcna-card-title">Virtuals /<br>Designs</div><div class="pcna-card-sub">Ask Nova for product, kit or packaging virtuals and keep them in Projects.</div><div class="card-art laptop" aria-hidden="true"><div class="screen">NORTHPOINT<br><small>SOLUTIONS</small></div></div><div class="pcna-arrow">→</div></a>
    <a class="pcna-card" href="?embed=true&page=quote" target="_self" onclick="event.preventDefault();window.location.assign(this.href);"><div class="pcna-card-icon">$</div><div class="pcna-card-title">Quote<br>Request</div><div class="pcna-card-sub">Quote a verified PCNA product at the requested quantity.</div><div class="card-art quote-sheet" aria-hidden="true"><div class="qline"></div><div class="qline short"></div><div class="qbars"></div></div><div class="pcna-arrow">→</div></a>
    <a class="pcna-card" href="?embed=true&page=projects" target="_self" onclick="event.preventDefault();window.location.assign(this.href);"><div class="pcna-card-icon">□</div><div class="pcna-card-title">Projects</div><div class="pcna-card-sub">View and manage your saved projects, orders and virtuals in one place.</div><div class="card-art notebook" aria-hidden="true"><div class="elastic"></div></div><div class="pcna-arrow">→</div></a>
  </div>
</div>
