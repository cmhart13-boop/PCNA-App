...
s=s.replace('    \"\"\"Compact native Streamlit mobile home matching the approved screenshot structure.\"\"\"', '    # Compact native Streamlit mobile home matching the approved screenshot structure.', 1)
